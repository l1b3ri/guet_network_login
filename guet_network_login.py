...
def login():
    os.system("curl -i -s -k -X $'GET' \
        ...
        $'http://10.0.1.5:801/eportal/portal/login?callback=dr1003&login_method=<登录方式>&user_account=,0,<学号>@cmcc&user_password=<密码>&wlan_user_ip=10.37.47.89&wlan_user_ipv6=&wlan_user_mac=000000000000&wlan_ac_ip=&wlan_ac_name=&jsVersion=4.1&terminal_type=1&lang=zh-cn&v=5021&lang=zh'")
